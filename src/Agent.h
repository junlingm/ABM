...
extern "C" {
   ...
   * 
   * @param state either NULL (empty list) or a list giving the initial
   * state of the agent
   * 
   ...
   * @param agent an external pointer returned by newAgent
   * 
   * @return an object of the State class which is an R list.
   */
   ...
   * 
   * @details In this framework, a state is an R list, each named
  ...
  /**
   * Unschedule (detach) an event to an agent
   * 
   * @param agent an external pointer returned by newAgent
   * 
   * @param event an external pointer returned by newEvent
  ...
  /**
   * Unschedule (detach) all event of an agent
   * 
   * @param agent an external pointer returned by newAgent
   * 
   * @return the agent itself
