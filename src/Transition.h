...
extern "C" {
  /**
   * Create an exponentially distributed waiting time
   * 
   * @param rate the rate of the exponential distribution
   * 
   * @return an external pointer pointing to a WaitingTime object
   */
  SEXP newExpWaitingTime(SEXP rate); 
  
  /**
   * Create a gamma distributed waiting time
   * 
   * @param shape the shape parameter of the gamma distribution
   * 
   * @param scale the scale parameter of the gamma distribution 
  ...
  /**
   * Create a random waiting time generator using an R function
   * 
   * @param function is an R function to generate waiting times
   * 
   * @return an external pointer pointing to a WaitingTime object
   * 
   * @details The R function should take exactly one argument "time"
   ...
   * one returned by newRWaitingTime or newGammaWaitingTime
   * 
   * @param time the current time, a length-1 numeric vector
   * 
